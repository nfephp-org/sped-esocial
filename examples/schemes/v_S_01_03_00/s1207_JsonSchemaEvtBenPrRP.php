...
$std->dmdev[0]->inforra->nrprocrra = '123456789012345671101'; //Opcional
...
$std->dmdev[0]->infoperapur->ideestab[0]->itensremun[0]->descfolha = new \stdClass(); //Opcional
$std->dmdev[0]->infoperapur->ideestab[0]->itensremun[0]->descfolha->tpdesc = "1"; //Indicativo do tipo de desconto. Valores válidos: 1 - eConsignado
$std->dmdev[0]->infoperapur->ideestab[0]->itensremun[0]->descfolha->instfinanc = "123"; //Código da Instituição Financeira concedente do empréstimo.
$std->dmdev[0]->infoperapur->ideestab[0]->itensremun[0]->descfolha->nrdoc = "12345678111"; //Número do contrato referente ao empréstimo.
$std->dmdev[0]->infoperapur->ideestab[0]->itensremun[0]->descfolha->observacao = "klasjdkljasdkljaskldj"; //opcional
