...
$std->dependente[0]->descrdep = 'bla bla bla';
...
$std->vinculo->infoceletista->matanotjud = 'aaaaaaaaaaa';
...
$std->vinculo->infoceletista->aprend->cnpjentqual = '12345678901234';
$std->vinculo->infoceletista->aprend->tpinsc = 1; //1 pu 2
$std->vinculo->infoceletista->aprend->nrinsc = '12345678901';
$std->vinculo->infoceletista->aprend->cnpjprat = '12345678901234';
