...
class EvtTabRubrica extends Factory implements FactoryInterface
{
    ...
    protected function toNode()
    {
        ...
        $evtTabRubrica = $this->dom->createElement("evtTabRubrica");
        $att = $this->dom->createAttribute('Id');
        $att->value = $evtid;
        $evtTabRubrica->appendChild($att);
        ...
        $evtTabRubrica->appendChild($ideEmpregador);
        


        $eSocial->appendChild($evtTabRubrica);
        $this->sign($eSocial);
    }
}
